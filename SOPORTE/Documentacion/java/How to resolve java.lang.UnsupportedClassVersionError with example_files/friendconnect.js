...
var friendconnect_serverVersion = "0.1-fe7681fa_faa961a4_10d78ca1_7dedf383_37299517.7";
...
a,fcGb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fcp](a)]=a)}};var fcKb=function(){this.blockSize=-1};var fcW=function(a,b,c){fcKb[fcK](this);this.l=a;this.blockSize=c||a.blockSize||16;this.gc=fcf(this.blockSize);this.eb=fcf(this.blockSize);this.cc(b)};fcS(fcW,fcKb);fcW[fc].cc=function(a){a[fcG]>this.blockSize&&(this.l[fcL](a),a=this.l[fcya](),this.l[fcsa]());for(var b,c=0;c<this.blockSize;c++)b=c<a[fcG]?a[c]:0,this.gc[c]=b^92,this.eb[c]=b^54;this.l[fcL](this.eb)};fcW[fc].reset=function(){this.l[fcsa]();this.l[fcL](this.eb)};fcW[fc].update=function(a,b){this.l[fcL](a,b)};
fcW[fc].digest=function(){var a=this.l[fcya]();this.l[fcsa]();this.l[fcL](this.gc);this.l[fcL](a);return this.l[fcya]()};fcW[fc].Rb=function(a){this[fcsa]();this[fcL](a);return this[fcya]()};var fcX=function(){fcKb[fcK](this);this.blockSize=64;this.c=[];this.La=[];this.Tc=[];this.Aa=[];this.Aa[0]=128;for(var a=1;a<this.blockSize;++a)this.Aa[a]=0;this.Ha=this.O=0;this[fcsa]()};fcS(fcX,fcKb);fcX[fc].reset=function(){this.c[0]=1732584193;this.c[1]=4023233417;this.c[2]=2562383102;this.c[3]=271733878;this.c[4]=3285377520;this.Ha=this.O=0};
fcX[fc].T=function(a,b){b||(b=0);var c=this.Tc;if(fcO(a))for(var d=0;16>d;d++)c[d]=a[fcCa](b)<<24|a[fcCa](b+1)<<16|a[fcCa](b+2)<<8|a[fcCa](b+3),b+=4;else for(d=0;16>d;d++)c[d]=a[b]<<24|a[b+1]<<16|a[b+2]<<8|a[b+3],b+=4;for(d=16;80>d;d++){var e=c[d-3]^c[d-8]^c[d-14]^c[d-16];c[d]=(e<<1|e>>>31)&4294967295}for(var f=this.c[0],l=this.c[1],k=this.c[2],m=this.c[3],n=this.c[4],g,d=0;80>d;d++)40>d?20>d?(e=m^l&(k^m),g=1518500249):(e=l^k^m,g=1859775393):60>d?(e=l&k|m&(l|k),g=2400959708):(e=l^k^m,g=3395469782),
...
fcX[fc].update=function(a,b){if(null!=a){fcGa(b)||(b=a[fcG]);for(var c=b-this.blockSize,d=0,e=this.La,f=this.O;d<b;){if(0==f)for(;d<=c;)this.T(a,d),d+=this.blockSize;if(fcO(a))for(;d<b;){if(e[f]=a[fcCa](d),++f,++d,f==this.blockSize){this.T(e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.blockSize){this.T(e);f=0;break}}this.O=f;this.Ha+=b}};
fcX[fc].digest=function(){var a=[],b=8*this.Ha;56>this.O?this[fcL](this.Aa,56-this.O):this[fcL](this.Aa,this.blockSize-(this.O-56));for(var c=this.blockSize-1;56<=c;c--)this.La[c]=b&255,b/=256;this.T(this.La);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.c[c]>>d&255,++b;return a};var fcY=function(a){this.Fb=a},fcLb=/\s*;\s*/;fcY[fc].isEnabled=function(){return navigator.cookieEnabled};fcY[fc].ec=function(a){return!/[;=\s]/[fcva](a)};fcY[fc].fc=function(a){return!/[;\r\n]/[fcva](a)};
fcY[fc].set=function(a,b,c,d,e,f){if(!this.ec(a))throw fch('Invalid cookie name "'+a+'"');if(!this.fc(b))throw fch('Invalid cookie value "'+b+'"');fcGa(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";f=f?";secure":"";0>c?c="":(c=0==c?new Date(1970,1,1):new Date(fcPa()+1E3*c),c=";expires="+c.toUTCString());this.Gc(a+"="+b+e+d+c+f)};fcY[fc].get=function(a,b){for(var c=a+"=",d=this.ra(),e=0,f;f=d[e];e++){if(0==f.lastIndexOf(c,0))return f.substr(c[fcG]);if(f==a)return""}return b};
fcY[fc].remove=function(a,b,c){var d=this.U(a);this.set(a,"",0,b,c);return d};fcY[fc].C=function(){return this.pa().keys};fcY[fc].N=function(){return this.pa().values};fcY[fc].X=function(){var a=this.Wa();return a?this.ra()[fcG]:0};fcY[fc].U=function(a){return fcGa(this.get(a))};fcY[fc].clear=function(){for(var a=this.pa().keys,b=a[fcG]-1;0<=b;b--)this.remove(a[b])};fcY[fc].Gc=function(a){this.Fb.cookie=a};fcY[fc].Wa=function(){return this.Fb.cookie};fcY[fc].ra=function(){return(this.Wa()||"")[fct](fcLb)};
fcY[fc].pa=function(){for(var a=this.ra(),b=[],c=[],d,e,f=0;e=a[f];f++)d=e[fcE]("="),-1==d?(b[fcA](""),c[fcA](e)):(b[fcA](e[fcDa](0,d)),c[fcA](e[fcDa](d+1)));return{keys:b,values:c}};var fcMb=new fcY(fce);fcMb.MAX_COOKIE_LENGTH=3950;var fcNb=function(a,b){fcea(a,b)},fcOb=function(a){a=a.className;return fcO(a)&&a[fcq](/\S+/g)||[]},fcQb=function(a,b){var c=fcOb(a),d=fcfb(arguments,1),e=c[fcG]+d[fcG];fcPb(c,d);fcNb(a,c[fcM](" "));return c[fcG]==e},fcPb=function(a,b){for(var c=0;c<b[fcG];c++)fcdb(a,b[c])||a[fcA](b[c])};var fcZ=function(){this.Ba="";this.Sc=fcRb};fcZ[fc].bc=!0;fcZ[fc].Xb=function(){return this.Ba};fcZ[fc].toString=function(){return"SafeUrl{"+this.Ba+"}"};
var fcSb=function(a){if(a instanceof fcZ&&a.constructor===fcZ&&a.Sc===fcRb)return a.Ba;fc$a("expected object of type SafeUrl, got '"+a+"'");return"type_error:SafeUrl"},fcTb=/^(?:(?:https?|mailto|ftp):|[^&:/?#]*(?:[/?#]|$))/i,fcWb=function(a){if(a instanceof fcZ)return a;a=a.bc?a.Xb():fci(a);a=fcTb[fcva](a)?fcUb(a):"about:invalid#zClosurez";return fcVb(a)},fcUb=function(a){try{var b=encodeURI(a)}catch(c){return"about:invalid#zClosurez"}return b[fco](fcXb,function(a){return fcYb[a]})},fcXb=/[()']|%5B|%5D|%25/g,
fcYb={"'":"%27","(":"%28",")":"%29","%5B":"[","%5D":"]","%25":"%"},fcRb={},fcVb=function(a){var b=new fcZ;b.Ba=a;return b};var fc_=function(a,b){fcj(this,a);fck(this,b)};fc_[fc].clone=function(){return new fc_(this[fcn],this[fcz])};fc_[fc].toString=function(){return"("+this[fcn]+" x "+this[fcz]+")"};fc_[fc].ceil=function(){fcj(this,fcg.ceil(this[fcn]));fck(this,fcg.ceil(this[fcz]));return this};fc_[fc].floor=function(){fcj(this,fcg.floor(this[fcn]));fck(this,fcg.floor(this[fcz]));return this};fc_[fc].round=function(){fcj(this,fcg[fcB](this[fcn]));fck(this,fcg[fcB](this[fcz]));return this};
...
function(a,b,c,d){function e(c){c&&b[fcm](fcO(c)?a.createTextNode(c):c)}for(;d<c[fcG];d++){var f=c[d];!fcJa(f)||fcKa(f)&&0<f.nodeType?e(f):fccb(fc7b(f)?fceb(f):f,e)}},fc8b=function(a){fc9a(a,"Node cannot be null or undefined.");return 9==a.nodeType?a:a.ownerDocument||a[fcH]},fc7b=function(a){if(a&&"number"==typeof a[fcG]){if(fcKa(a))return"function"==typeof a.item||"string"==typeof a.item;if("function"==fcIa(a))return"function"==typeof a.item}return!1};var fc9b="StopIteration"in fcN?fcN.StopIteration:fch("StopIteration"),fc$b=function(){};fc$b[fc].next=function(){throw fc9b;};fc$b[fc].__iterator__=function(){return this};var fc1=function(a,b){this.m={};this.h=[];this.ha=this.H=0;var c=arguments[fcG];if(1<c){if(c%2)throw fch("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.addAll(a)};fc1[fc].X=function(){return this.H};fc1[fc].N=function(){this.S();for(var a=[],b=0;b<this.h[fcG];b++){var c=this.h[b];a[fcA](this.m[c])}return a};fc1[fc].C=function(){this.S();return this.h.concat()};fc1[fc].U=function(a){return fcac(this.m,a)};
fc1[fc].clear=function(){this.m={};fcda(this.h,0);this.ha=this.H=0};fc1[fc].remove=function(a){return fcac(this.m,a)?(delete this.m[a],this.H--,this.ha++,this.h[fcG]>2*this.H&&this.S(),!0):!1};fc1[fc].S=function(){if(this.H!=this.h[fcG]){for(var a=0,b=0;a<this.h[fcG];){var c=this.h[a];fcac(this.m,c)&&(this.h[b++]=c);a++}fcda(this.h,b)}if(this.H!=this.h[fcG]){for(var d={},b=a=0;a<this.h[fcG];)c=this.h[a],fcac(d,c)||(this.h[b++]=c,d[c]=1),a++;fcda(this.h,b)}};
fc1[fc].get=function(a,b){return fcac(this.m,a)?this.m[a]:b};fc1[fc].set=function(a,b){fcac(this.m,a)||(this.H++,this.h[fcA](a),this.ha++);this.m[a]=b};fc1[fc].addAll=function(a){var b;a instanceof fc1?(b=a.C(),a=a.N()):(b=fcib(a),a=fchb(a));for(var c=0;c<b[fcG];c++)this.set(b[c],a[c])};fc1[fc].forEach=function(a,b){for(var c=this.C(),d=0;d<c[fcG];d++){var e=c[d],f=this.get(e);a[fcK](b,f,e,this)}};fc1[fc].clone=function(){return new fc1(this)};
fc1[fc].__iterator__=function(a){this.S();var b=0,c=this.ha,d=this,e=new fc$b;e.next=function(){if(c!=d.ha)throw fch("The map has changed since the iterator was created");if(b>=d.h[fcG])throw fc9b;var e=d.h[b++];return a?e:d.m[e]};return e};var fcac=function(a,b){return fcaa[fc].hasOwnProperty[fcK](a,b)};var fccc=function(a,b,c){if(fcO(b))fcbc(a,c,b);else for(var d in b)fcbc(a,b[d],d)},fcbc=function(a,b,c){(c=fcdc(a,c))&&(a[fcv][c]=b)},fcec={},fcdc=function(a,b){var c=fcec[b];if(!c){var d=fc3a(b),c=d;void 0===a[fcv][d]&&(d=(fcub?"Webkit":fctb?"Moz":fcV?"ms":fcsb?"O":null)+fc4a(d),void 0!==a[fcv][d]&&(c=d));fcec[b]=c}return c},fcfc=function(a,b){var c=fc8b(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""},fcgc=function(a,
...
fcR("goog.peoplesense.util.editSSProfile",fcCc);fcR("goog.peoplesense.util.setStickyViewParamToken",fcGc);fcR("google.friendconnect.renderSignInButton",fcFc);fcR("goog.peoplesense.util.share",fcHc);fcR("goog.peoplesense.util.userAgent.IE",fcV);var fcIc={},fc2=function(a){this.j=new fc1;this.snippetId=a.id;this.site=a.site;a=a["view-params"];var b=a.skin;this.rc=(b?b.POSITION:"top")||"top";this.Uc={allowAnonymousPost:a.allowAnonymousPost||!1,scope:a.scope||"SITE",docId:a.docId||"",features:a.features||"video,comment",startMaximized:"true",disableMinMax:"true",skin:b};this.absoluteBottom=fcV&&!fcAb("7");this.fixedIeSizes=fcV;fcc[fcxa]?fcc[fcxa]("resize",fcQ(this.nb,this),!1):fcc.attachEvent("onresize",fcQ(this.nb,this));this.Bb()};
fc2[fc].Bb=function(){if(!this.site)throw fch("Must supply site ID.");if(!this.snippetId)throw fch("Must supply a snippet ID.");};fc2[fc].b=10;fc2[fc].Ka=1;fc2[fc].B="fc-friendbar-";fc2[fc].F=fc2[fc].B+"outer";fc2[fc].qb=fc2[fc].F+"-shadow";fc2[fc].render=function(){fce.write(this.Jb());var a=fc_b(this.snippetId);fcl(a,this.W())};fc2[fc].Kb=function(){var a=fc_b(this.F);return a=fcmc(fcnc,a)[fcn]};fc2[fc].nb=function(){for(var a=this.j.C(),b=0;b<a[fcG];b++)this.Dc(a[b]);goog&&fcpc&&fcqc&&fcJc&&fcKc("resize")};
fc2[fc].v=function(){return this.rc};fc2[fc].g=function(a){return this.B+"shadow-"+a};fc2[fc].qa=function(a){return this.B+"menus-"+a};fc2[fc].Z=function(a){return this.B+a+"Target"};fc2[fc].na=function(a){return this.B+a+"Drawer"};fc2[fc].ab=function(){return this.Z("")};fc2[fc].bb=function(){return this.B+"wallpaper"};fc2[fc].Xa=function(){return this.na("")};
fc2[fc].Jb=function(){var a=fcc.friendconnect_imageUrl+"/",b=a+"shadow_tc.png",c=a+"shadow_bc.png",d=a+"shadow_bl.png",e=a+"shadow_tl.png",f=a+"shadow_tr.png",l=a+"shadow_br.png",a=a+"shadow_cr.png",k=function(a,b){return fcV?'filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="'+a+'", sizingMethod="scale");':"background-image: url("+a+");background-repeat: "+b+"; "},m="position:absolute; top:";"top"!=this.v()&&(m="position:fixed; bottom:",this.absoluteBottom&&(m="position:absolute; bottom:"));
var n=c;"top"!=this.v()&&(n=b);var g=0,h=[];h[g++]='<style type="text/css">';"top"!=this.v()&&this.absoluteBottom&&(h[g++]="html, body {height: 100%; overflow: auto; };");h[g++]="#"+this.F+" {";h[g++]="background:#E0ECFF;";h[g++]="left:0;";h[g++]="height: "+(fcV?"35px;":"36px;");"top"!=this.v()&&this.absoluteBottom&&(h[g++]="margin-right: 20px;");h[g++]="padding:0;";h[g++]=m+" 0;";h[g++]="width:100%;";h[g++]="z-index:5000;";h[g++]="}";h[g++]="#"+this.qb+" {";h[g++]=k(n,"repeat-x");h[g++]="left:0;";
h[g++]="height:"+this.b+"px;";"top"!=this.v()&&this.absoluteBottom&&(h[g++]="margin-right: 20px;");h[g++]="padding:0;";h[g++]=m+(fcV?"35px;":"36px;");h[g++]="width:100%;";h[g++]="z-index:4998;";h[g++]="}";h[g++]="."+this.Xa()+" {";h[g++]="display: block;";h[g++]="padding:0;";h[g++]=m+(fcV?"34px;":"35px;");h[g++]="z-index:4999;";h[g++]="}";h[g++]="."+this.bb()+" {";h[g++]="background: white;";h[g++]="height: 100%;";h[g++]="margin-right: "+this.b+"px;";h[g++]="}";h[g++]="."+this.ab()+" {";h[g++]="border: "+
this.Ka+"px solid #ccc;";h[g++]="height: 100%;";h[g++]="left: 0;";h[g++]="background-image: url("+fcc.friendconnect_imageUrl+"/loading.gif);";h[g++]="background-position: center;";h[g++]="background-repeat: no-repeat;";h[g++]="}";h[g++]="."+this.g("cr")+" {";h[g++]=k(a,"repeat-y");h[g++]="height: 100%;";h[g++]="position:absolute;";h[g++]="right: 0;";h[g++]="top: 0;";h[g++]="width:"+this.b+"px;";h[g++]="}";h[g++]="."+this.g("bl")+" {";h[g++]=k(d,"no-repeat");h[g++]="height: "+this.b+"px;";h[g++]="position:absolute;";
...
fc2[fc].W=function(){var a=['<div id="'+this.F+'"></div>','<div id="'+this.qb+'"></div>','<div id="'+this.qa(this.j.X())+'"></div>'];return a[fcM]("")};fc2[fc].Db=function(a,b,c,d){this.j.U(a)||(b=new fc3(this,a,b,c,d),c=this.j.X(),d=fc_b(this.qa(c)),fcl(d,b.W()+'<div id="'+this.qa(c+1)+'"></div>'),this.j.set(a,b))};fc2[fc].ua=function(a){(a=this.j.get(a))&&a.drawer&&fcoc(a.drawer,!1)};fc2[fc].tc=function(a){if(a=this.j.get(a))a.rendered=!1};
fc2[fc].refresh=function(){for(var a=this.j.C(),b=0;b<a[fcG];b++){var c=a[b];this.ua(c);this.tc(c)}};fc2[fc].nc=function(a){for(var b=this.j.N(),c=0;c<b[fcG];c++){var d=b[c];if(d.id==a){d.Qc();break}}};fc2[fc].mc=function(a){for(var b=this.j.N(),c=0;c<b[fcG];c++){var d=b[c];if(d.id==a){d.jc();break}}};fc2[fc].Dc=function(a){(a=this.j.get(a))&&a.drawer&&a.wa()&&(a.la(),a.Ta(),a.Ja())};
fc2[fc].Pc=function(a,b){var c=this.j.get(a);if(c){c.drawer||(c.drawer=fc_b(this.na(c[fcF])),c.target=fc_b(this.Z(c[fcF])),c.sha_bc=fc1b(fce,"div","top"==this.v()?this.g("bc"):this.g("tc"),c.drawer)[0],c.sha_cr=fc1b(fce,"div",this.g("cr"),c.drawer)[0]);for(var d=this.j.C(),e=0;e<d[fcG];e++){var f=d[e];a!==f&&this.ua(f)}c.la(b);fcoc(c.drawer,!0);fcc.setTimeout(function(){c.Ja();c.Ta();c.render()},0)}};
var fc3=function(a,b,c,d,e){this.id=-1;this.bar=a;this.name=b;this.constraints=d;this.skin=e||{};fck(this,this.skin.HEIGHT||"0");this.url=fcc[fcBa]+c;this.sha_bc=this.target=this.drawer=null;this.loaded=this.rendered=!1;this.la()};
fc3[fc].la=function(a){fckb(this.constraints,a||{});fckb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcwa]&&this.constraints[fcta]){a=this.bar.Kb();var b=this.constraints[fcwa],c=this.constraints[fcta];a-=b+c;a%2&&(--a,this.skin.right=this.skin[fcta]+1);fcj(this.skin,a);delete this.skin[fcwa]}};
fc3[fc].Ja=function(){if(this.drawer){if(this.skin[fcn]){var a=this.bar.Ka,b=this.bar.b,c=fcV?2:0;fckc(this.target,this.skin[fcn],"");fckc(this.sha_bc,this.skin[fcn]-b+2*a-c,"");this.skin.rightShadow?fckc(this.drawer,this.skin[fcn]+b+2*a-c,""):fckc(this.drawer,this.skin[fcn]+2*a-c,"")}this.skin[fcta]&&(this.drawer[fcv].right=this.skin[fcta]+0+"px")}};
fc3[fc].Ta=function(){if(fcV&&this.drawer){var a=fcmc(fcnc,this.target),b=a[fcn]-this.bar.b,a=a[fcz];0>b&&(b=0);this.sha_bc&&this.sha_bc[fcv]&&fckc(this.sha_bc,b,"");this.sha_cr&&this.sha_cr[fcv]&&fckc(this.sha_cr,"",a)}};
fc3[fc].W=function(){var a="display:none;",b="position: relative; ",c="",d="",e="",f="",l=!!this.skin.rightShadow;l||(c+="display: none; ",e+="display: none; ",d+="right: 0px; ",f+="margin-right: 0px; ");for(var k in this.skin){var m=Number(this.skin[k]);l&&0==fcTa(k,"width")&&(m+=this.bar.b);0==fcTa(k,"height")&&(b+=k+": "+m+"px; ");"rightShadow"!=k&&(0==fcTa(k,"height")&&(m+=this.bar.b),0==fcTa(k,"width")&&(m+=2),a+=k+": "+m+"px; ");fcV&&0==fcTa(k,"width")&&(m=l?m-2*this.bar.b:m-this.bar.b,d+=k+
": "+m+"px; ")}fcV&&0<(this[fcz]|0)&&(l=(this[fcz]|0)+2,c+="height: "+l+"px; ");l=0;k=[];k[l++]='<div id="'+this.bar.na(this[fcF])+'"class="'+this.bar.Xa()+'"style="'+a+'"> ';"bottom"==this.bar.v()&&(k[l++]='<div class="'+this.bar.g("tl")+'"></div> <div class="'+this.bar.g("tc")+'"style="'+d+'"></div> <div class="'+this.bar.g("tr")+'"style="'+e+'"></div> ');k[l++]='<div style="'+b+'"> <div class="'+this.bar.bb()+'"style="'+f+'"><div id="'+this.bar.Z(this[fcF])+'"class="'+this.bar.ab()+'"></div> <div class="'+
this.bar.g("cr")+'"style="'+c+'"></div> </div> </div> ';"top"==this.bar.v()&&(k[l++]='<div class="'+this.bar.g("bl")+'"></div> <div class="'+this.bar.g("bc")+'"style="'+d+'"></div> <div class="'+this.bar.g("br")+'"style="'+e+'"></div> ');k[l++]="</div> ";return k[fcM]("")};fc3[fc].Qc=function(){this.rendered=this.wa()};fc3[fc].jc=function(){this.loaded=this.wa()};fc3[fc].wa=function(){return!!this.drawer&&"none"!=this.drawer[fcv].display};
fc3[fc].render=function(){if(0==this.rendered){var a={};a.url=this.url;a.id=this.bar.Z(this[fcF]);a.site=this.bar.site;a["view-params"]=fcP(this.bar.Uc);"profile"==this[fcF]&&(a["view-params"].profileId="VIEWER");this.skin&&fckb(a["view-params"].skin,this.skin);a["view-params"].menuName=this[fcF];a["view-params"].opaque="true";a["view-params"].menuPosition=this.bar.rc;fck(a,"1px");fcc.google&&fcIc&&fc4&&(this.id=fc4.render(a))}};fcR("google.friendconnect.FriendBar",fc2);var fcMc=function(a){a=new fcLc(a);if(a.ya()%5)throw fch();for(var b=[],c=0;0<a.ya();c++)b[c]="0123456789abcdefghijklmnopqrstuv"[fcp](a.pc(5));return b[fcM]("")},fcLc=function(a){this.P=this.w=0;this.ka=a};fcLc[fc].ya=function(){return 8*(this.ka[fcG]-this.P)-this.w};
fcLc[fc].pc=function(a){var b=0;if(a>this.ya())throw fch();if(0<this.w){var b=255>>this.w&this.ka[this.P],c=8-this.w,d=fcg.min(a%8,c),c=c-d,b=b>>c;a-=d;this.w+=d;8==this.w&&(this.w=0,this.P++)}for(;8<=a;)b<<=8,b|=this.ka[this.P],this.P++,a-=8;0<a&&(b<<=a,b|=this.ka[this.P]>>8-a,this.w=a);return b};var fcNc=(new Date).getTime(),fc5=function(){},fcOc=function(){},fcPc=function(){},fcQc=function(){};fcS(fcQc,fcPc);var fcRc=function(a){if(a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);if(this.viewParams)for(var c in this.viewParams)/^FC_RELOAD_.*$/[fcva](c)&&(this.viewParams[c]=null)};fcRc[fc].render=function(a){var b=this;a&&(b.Rc(),this.Mb(function(c){fccc(a,"visibility","hidden");fcl(a,c);b.refresh(a,c);c=function(a){fccc(a,"visibility","visible")};c=fcNa(c,a);fcba(c,500);b.chrome=a}))};
fcRc[fc].Mb=function(a){return this.Sb(a)};var fc6=function(a){fcRc[fcK](this,a);this.ca="../../";this.rpcToken=fci(fcg[fcB](2147483647*fcg.random()))};fcS(fc6,fcRc);fc6[fc].vb="gfc_iframe_";fc6[fc].wb="friendconnect";fc6[fc].Ua="";fc6[fc].Ec="rpc_relay.html";fc6[fc].fa=function(a){this.ca=a};fc6[fc].Rc=function(){return this.Ua=fci(fcg[fcB](2147483647*fcg.random()))};fc6[fc].oa=function(){return this.vb+this.Ua+"_"+this.id};
fc6[fc].refresh=function(a,b){var c=fc4.Xc,d,e={},f=fc4.Va(this.communityId),l=f[fct]("~"),k=fc4.Eb;if(k&&1<l[fcG]){d=l[2];var l=l[1],m=[this.specUrl,this.communityId,l,k][fcM](":");e.sig=fc4.hash(d,m);e.userId=l;e.dateStamp=k}e.container=this.wb;e.mid=this.id;e.nocache=fc4.qc;e.view=this.ia;e.parent=fc4.aa;this.debug&&(e.debug="1");this.specUrl&&(e.url=this.specUrl);this.communityId&&(k=fca[fcx][fcI]().profileId,e.communityId=this.communityId,(d=fca[fcx][fcI]().psinvite)&&(e.psinvite=d),k&&(e.profileId=
k));e.caller=fcSc();e.rpctoken=this.rpcToken;k=!1;d="";l=/Version\/3\..*Safari/;if((l=fcub&&fcmb[fcq](l))||!fc4.$[this.specUrl]&&this.viewParams)e["view-params"]=fca[fcpa][fcua](this.viewParams),d="?viewParams="+fcb(e["view-params"]),k=!0;this.prefs&&(e.prefs=fca[fcpa][fcua](this.prefs));this.viewParams&&this.sendViewParamsToServer&&(e["view-params"]=fca[fcpa][fcua](this.viewParams));this[fcza]&&(e.locale=this[fcza]);this.secureToken&&(e.st=this.secureToken);l=fc4.$a(this.specUrl);d=l+"ifr"+d+(this.hashData?
"&"+this.hashData:"");1!=fc4.Wc||k||f||this.secureToken?f&&!e.sig&&(e.fcauth=f):e.sig||(c="get");f=this.oa();fcTc(f,d,c,e,a,b,this.rpcToken)};var fc7=function(){this.o={};this.aa="http://"+fce[fcu].host;this.ia="default";this.qc=1;this.ad=0;this.Yc="US";this.Zc="en";this.$c=2147483647};fcS(fc7,fcOc);fc7[fc].I=fcRc;fc7[fc].K=new fcQc;fc7[fc].pb=function(a){this.qc=a};fc7[fc].Sa=function(a){this.Wc=a};fc7[fc].Za=function(a){return"gadget_"+a};fc7[fc].J=function(a){return this.o[this.Za(a)]};
fc7[fc].V=function(a){return new this.I(a)};fc7[fc].xb=function(a){a.id=this.Tb();this.o[this.Za(a.id)]=a};fc7[fc].oc=0;fc7[fc].Tb=function(){return this.oc++};var fcVc=function(){fc7[fcK](this);this.K=new fcUc};fcS(fcVc,fc7);fcVc[fc].I=fc6;fcVc[fc].ea=function(a){a[fcq](/^http[s]?:\/\//)||(a=fce[fcu][fcqa][fcq](/^[^?#]+\//)[0]+a);this.aa=a};fcVc[fc].R=function(a){var b=this.K.Ya(a);a.render(b)};var fcUc=function(){this.Ib={}};fcS(fcUc,fcPc);
fcUc[fc].yb=function(a,b){this.Ib[a]=b;var c=fce[fcD](b).className;c||0!=c[fcG]||fcea(fce[fcD](b),"gadgets-gadget-container")};fcUc[fc].Ya=function(a){return(a=this.Ib[a.id])?fce[fcD](a):null};var fc8=function(a){fc6[fcK](this,a);a=a||{};this.ia=a.view||"profile"};fcS(fc8,fc6);fc8[fc].Ab="canvas.html";fc8[fc].Gb="/friendconnect/embed/";
var fcSc=function(){var a="1"==fca[fcx][fcI]().canvas||"1"==fca[fcx][fcI]().embed,b=null;a&&(b=fca[fcx][fcI]().caller);b||(a=fce[fcu],b=a.search[fco](/([&?]?)psinvite=[^&]*(&?)/,function(a,b,e){return e?b:""}),b=a.protocol+"//"+a.hostname+(a.port?":"+a.port:"")+a.pathname+b);return b};fc8[fc].Nc=function(a){this.ia=a};fc8[fc].ta=function(){return this.ia};fc8[fc].getBodyId=function(){return this.oa()+"_body"};
fc8[fc].Sb=function(a){var b=this.specUrl;void 0===b&&(b="");var b=(fc4.$a(b)||this.ca)+this.Ec,c=this.oa();fca.rpc.setRelayUrl(c,b);b='<div id="'+this.getBodyId()+'"><iframe id="'+c+'" name="'+c;b=0==this[fcz]?b+'" style="width:1px; height:1px;':b+'" style="width:100%;';this.viewParams.opaque&&(b+="background-color:white;");b+='"';b+=' frameborder="0" scrolling="no"';this.viewParams.opaque||(b+=' allowtransparency="true"');b+=this[fcz]?' height="'+this[fcz]+'"':"";b+=this[fcn]?' width="'+this[fcn]+
...
0;d<c[fcG];d++)delete b.skin[c[d]];b=fcb(fca[fcpa][fcua](b));b=b[fco]("\\","%5C");return fc4.aa+this.Ab+"?url="+fcb(this.specUrl)+(a?"&"+a:"")+"&view-params="+b};fc8[fc].M=function(a){a=a||fcd+this.Gb+this.communityId;return this.Nb(a,"embed=1")};fc8[fc].L=function(a){return'<iframe src="'+this.M(a)+'" style="height:500px" scrolling="no" allowtransparency="true" border="0" frameborder="0" ></iframe>'};
fc8[fc].Nb=function(a,b){var c=fcb(fca[fcpa][fcua](this.viewParams)),c=c[fco]("\\","%5C");return a+"?url="+fcb(this.specUrl)+(b?"&"+b:"")+"&view-params="+c};fc8[fc].Wb=function(){var a="1"==fca[fcx][fcI]().canvas||"1"==fca[fcx][fcI]().embed,b=null;a&&((b=fca[fcx][fcI]().caller)||(b="javascript:history.go(-1)"));return b};fc8[fc].Yb=function(a){var b=null;if("canvas"==a)b=this.Lb();else if("profile"==a)b=this.Wb();else return null;return fcSb(fcWb(b))};
var fc9=function(){fcVc[fcK](this);fca.rpc[fcs]("signin",fc5[fc].signin);fca.rpc[fcs]("signout",fc5[fc].signout);fca.rpc[fcs]("resize_iframe",fc5[fc].ob);fca.rpc[fcs]("set_title",fc5[fc].setTitle);fca.rpc[fcs]("requestNavigateTo",fc5[fc].mb);fca.rpc[fcs]("api_loaded",fc5[fc].Ia);fca.rpc[fcs]("createFriendBarMenu",fc5[fc].Oa);fca.rpc[fcs]("showFriendBarMenu",fc5[fc].rb);fca.rpc[fcs]("hideFriendBarMenu",fc5[fc].cb);fca.rpc[fcs]("putReloadViewParam",fc5[fc].ib);fca.rpc[fcs]("getViewParams",fc5[fc].Ra);
fca.rpc[fcs]("getContainerBaseTime",fc5[fc].Qa);fca.rpc[fcs]("openLightboxIframe",fc5[fc].hb);fca.rpc[fcs]("showMemberProfile",fc5[fc].tb);fca.rpc[fcs]("closeLightboxIframe",fcQ(this.G,this));fca.rpc[fcs]("setLightboxIframeTitle",fcQ(this.Jc,this));fca.rpc[fcs]("refreshAndCloseIframeLightbox",fcQ(this.sc,this));var a=fcWc;a[fcs]();a.ub(this,"load",this.$b);a.ub(this,"start",this.ac);this.ca="../../";this.ea("");this.pb(0);this.Sa(1);this.xa=null;this.apiVersion="0.8";this.openSocialSecurityToken=
null;this.da="";this.Pa={};this.ic=null;this.hc=!1;this.Eb=this.lc=this.lastIframeLightboxOpenArguments=this.lastLightboxCallback=this.lastLightboxDialog=null;this.Xc="post"};fcS(fc9,fcVc);fc9[fc].Hc=function(a){this.Eb=a};fc9[fc].I=fc8;fc9[fc].$={};fc9[fc].Lc=function(a){this.xa=a};fc9[fc].$a=function(a){var b=fc9[fc].$[a];if(!b)if(0!==this.xa[fcE]("https://")){var b=this.Cb(a),c="//";0==a[fcE]("https://")?c="https://":0==a[fcE]("http://")&&(c="http://");b=[c,b,this.xa][fcM]("")}else b=this.xa;return b};
fc9[fc].Cb=function(a){var b=new fcX;a=fcCb(a);b[fcL](a);b=b[fcya]();return b=fcMc(b)};
...
fc9[fc].Hb=function(){var a=fca[fcx][fcI]().fcsite,b=fca[fcx][fcI]().fcprofile;a&&b&&fc4.Ga(b,a)};fc9[fc].Ic=function(a,b){this.$[a]=b};fc9[fc].ba=function(){var a=/Version\/3\..*Safari/;if(a=fcub&&fcmb[fcq](a))fce[fcu].reload();else{null!=fc4.i&&fc4.i.refresh();for(var b in fc4.o)a=fc4.o[b],this.R(a);null!=this.lastIframeLightboxOpenArguments&&(b=this.lastIframeLightboxOpenArguments,this.G(),this.za[fcy](this,b))}};
fc9[fc].ea=function(a){a[fcq](/^http[s]?:\/\//)||(a=a&&0<a[fcG]&&"/"==a[fcDa](0,1)?fce[fcu][fcqa][fcq](/^http[s]?:\/\/[^\/]+\//)[0]+a[fcDa](1):fce[fcu][fcqa][fcq](/^[^?#]+\//)[0]+a);this.aa=a};fc9[fc].ma=function(a){return"fcauth"+a};fc9[fc].sa=function(a){return"fcauth"+a+"-s"};fc9[fc].hash=function(a,b){var c=new fcX,d=fcJb(a,!0),c=new fcW(c,d,64),d=fcCb(b),c=c.Rb(d);return fcIb(c,!0)};fc9[fc].Va=function(a){return a=fcMb.get(this.ma(a))||fcMb.get(this.sa(a))||this.Pa[a]||""};
fc9[fc].fa=function(a){this.ca=a};fc9[fc].Mc=function(a){this.da=a};fc9[fc].V=function(a){a=new this.I(a);a.fa(this.ca);return a};fc9[fc].ta=function(){return this.ia};fc9[fc].Kc=function(a){this.lc=a};var fc$=function(a){return(a=a[fcq](/_([0-9]+)$/))?fcca(a[1],10):null};
fc9[fc].ga=function(a,b,c,d,e,f){this.Vc||(this.ja(fcc[fcBa]+"/friendconnect/styles/container.css?d="+this.da),this.Vc=!0);var l=fcYc(d);this.ic!=(l?"rtl":"ltr")&&(this.ja(fcc[fcBa]+"/friendconnect/styles/lightbox"+(l?"-rtl":"")+".css?d="+this.da),this.ic=l?"rtl":"ltr");this.hc||(this.zb(fcc[fcBa]+"/friendconnect/script/lightbox.js?d="+this.da),this.hc=!0);b=b||0;if(goog.ui&&goog.ui[fcoa]){this.G();b=new goog.ui[fcoa]("lightbox-dialog",!0);var k=this;goog.events.listen(b,goog.ui[fcoa].EventType.AFTER_HIDE,
function(){k.lastLightboxCallback&&k.lastLightboxCallback();k.Na()});b.setDraggable(!0);b.setDisposeOnHide(!0);b.setBackgroundElementOpacity(.5);b.setButtonSet(new goog.ui[fcoa].ButtonSet);this.lastLightboxDialog=b;this.lastLightboxCallback=c||null;c=b.getDialogElement();e=e||702;fccc(c,"width",fci(e)+"px");f&&fccc(c,"height",fci(f)+"px");a(b);b.getDialogElement()[fcv].direction=l?"rtl":"ltr"}else if(5>b)b++,a=fcQ(this.ga,this,a,b,c,d,e,f),fcba(a,1E3);else throw this.Na(),fch("lightbox.js failed to load");
};fc9[fc].G=function(a){var b=this.lastLightboxDialog,c=this.lastLightboxCallback;this.lastLightboxCallback=null;null!=b&&(this.lastLightboxDialog.dispatchEvent(goog.ui[fcoa].EventType.AFTER_HIDE),b.dispose(),null!=c&&c(a))};fc9[fc].Na=function(){this.lastIframeLightboxOpenArguments=this.lastLightboxCallback=this.lastLightboxDialog=null};fc9[fc].Jc=function(a){this.lastLightboxDialog&&this.lastLightboxDialog.setTitle(a)};fc9[fc].sc=function(){this.G();this.ba()};
fc5[fc].mb=function(a,b){var c=fc$(this.f),c=fc4.J(c),d=fcP(c.originalParams);b&&(d["view-params"]=d["view-params"]||{},d["view-params"]=b);d.locale=c[fcza];if(c.useLightBoxForCanvas)d.presentation=a,null!=fc4.lastLightboxDialog?fc4.G():fc4.sb(d);else if((c=c.Yb(a))&&fce[fcu][fcqa]!=c)if("1"==fca[fcx][fcI]().embed)try{fcc.parent.location=c}catch(e){fcc.top.location=c}else fce[fcu].href=c};
fc9[fc].sb=function(a,b){a=a||{};var c=a[fcza],d=fcYc(c),e=this;this.G();this.ga(function(b){var c=fc0("div",{},fc0("div",{id:"gadget-signin",style:"background-color:#ffffff;height:32px;"}),fc0("div",{id:"gadget-lb-canvas",style:"background-color:#ffffff;"}));b.getTitleTextElement()[fcm](fc0("div",{id:"gfc-canvas-title",style:"color:#000000;"}));b[fcEa]()[fcm](c);b.setVisible(!0);var c=fcP(a),k=fc4b(fcc),m=fcg[fcB](.7*k[fcz]),k={BORDER_COLOR:"#cccccc",ENDCAP_BG_COLOR:"#e0ecff",ENDCAP_TEXT_COLOR:"#333333",
...
k);e.render(c);m={id:"gadget-signin",presentation:"canvas"};m.site=c.site;m.titleDivId="gfc-canvas-title";m["view-params"]={};m["view-params"].opaque=!0;m.keepMax=c.keepMax;c.securityToken&&(m.securityToken=c.securityToken);c=fcP(k);c.ALIGNMENT=d?"left":"right";e.kb(m,c);b.reposition()},void 0,b,c)};fc5[fc].rb=function(a,b){null!=fc4.i&&fc4.i.Pc(a,b)};fc5[fc].cb=function(a){null!=fc4.i&&fc4.i.ua(a)};
fc5[fc].hb=function(a,b,c,d,e,f,l,k,m,n){var g=this.f;a=a+(0<=a[fcE]("?")?"&":"?")+"iframeId="+g;fc4.za(a,b,c,d,e,f,l,k,m,n,this.callback)};
fc9[fc].za=function(a,b,c,d,e,f,l,k,m,n,g){var h=fc4b(fcc);null==d&&(d=fcg[fcB](.7*h[fcz]));null==c&&(c=fcg[fcB](.7*h[fcn]));for(var p=[],h=0;h<arguments[fcG]&&10>h;h++)p[fcA](arguments[h]);if("/"==!a[0])throw fch("lightbox iframes must be relative to fc server");var t=this,q=f?fcP(f):{},u=fci(fcg[fcB](2147483647*fcg.random())),r="gfc_lbox_iframe_"+u;fca.rpc.setAuthToken(r,u);b||(b=fc4.openSocialSecurityToken);var v=fc4.openSocialSiteId;fc4.ga(function(c){t.lastIframeLightboxOpenArguments=p;var f=
"st="+fcb(b)+"&parent="+fcb(fc4.aa)+"&rpctoken="+fcb(u);k||(q.iframeId=r,q.iurl=a,a=fcd+"/friendconnect/lightbox");var g=d-54;fck(q,g);var h='<iframe id="'+r,h=h+('" width="100%" height="'+g+'" frameborder="0" scrolling="auto"></iframe>');c.setContent(h);e&&(c.setTitle(e),n&&(g=c.getTitleTextElement(),fcQb(g,"lightbox-dialog-title-small-text")));c.setVisible(!0);m||(q.fcauth=fc4.Va(v));a+=(0<=a[fcE]("?")?"&":"?")+f+"&communityId="+v;fcTc(r,a,"POST",q,null,null,null)},void 0,g,void 0,c,d)};
fc5[fc].Ra=function(){var a=fc$(this.f),a=fc4.J(a);return a.viewParams};fc5[fc].Qa=function(){return fcNc};fc5[fc].ib=function(a,b){var c=fc$(this.f),c=fc4.J(c);c.viewParams[a]=b};fc9[fc].$b=function(a,b){null!=fc4.i&&fc4.i.mc(b)};fc9[fc].ac=function(a,b){null!=fc4.i&&fc4.i.nc(b)};fc5[fc].Oa=function(a,b,c,d){null!=fc4.i&&fc4.i.Db(a,b,c,d)};fc9[fc].R=function(a){var b=this.K.Ya(a);a.render(b);this.K.postProcessGadget&&this.K.postProcessGadget(a)};
fc5[fc].signout=function(a){fc4.jb(fc4.ma(a));fc4.jb(fc4.sa(a));fc4.Pa={};fc4.ba();return!1};fc9[fc].jb=function(a){for(var b=fce[fcu].pathname,b=b[fct]("/"),c=0;c<b[fcG];c++){for(var d=fcf(c+1),e=0;e<c+1;e++)d[e]=b[e];fcMb.remove(a,d[fcM]("/")+"/")}};
fc5[fc].ob=function(a){var b=fce[fcD](this.f);b&&0<a&&fck(b[fcv],a+"px");(b=fce[fcD](this.f+"_body"))&&0<a&&fck(b[fcv],a+"px");if(b=fc$(this.f)){var c=fc4.J(b);c&&((b=fce[fcD](c.divId))&&0<a&&(c&&c[fcra]&&c[fcra]<a&&(a=c[fcra],b[fcv].overflowY="auto"),fck(b[fcv],a+"px")),!c.keepMax&&"canvas"==c.ta()&&fc4.lastLightboxDialog&&fc4.lastLightboxDialog.reposition(),fccc(c.chrome,"visibility","visible"))}};fc5[fc].setTitle=function(a){var b=fc$(this.f),b=fc4.J(b);(b=b.titleDivId)&&fcl(fce[fcD](b),fca[fcx].escapeString(a))};
fc5[fc].signin=function(a,b,c){fcMb.set(fc4.ma(a),b,31104E3,c);fcMb.set(fc4.sa(a),b,-1,c);fc4.Pa[a]=b;fc4.ba()};var fc_c=function(a){fcFc(a,fcZc)};fc9[fc].yc=function(a,b){b&&this.u(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/members.xml";this.render(this.D(a,c))};fc9[fc].Ac=function(a,b){b&&this.u(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/review.xml";c["view-params"]={startMaximized:"true",disableMinMax:"true",features:"review"};this.render(this.D(a,c))};
fc9[fc].Ca=function(a,b){b&&this.u(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/wall.xml";c["view-params"]={startMaximized:"true",disableMinMax:"true",features:"comment"};this.render(this.D(a,c))};fc9[fc].kb=function(a,b){b&&this.u(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/signin.xml";fck(c,32);this.render(this.D(a,c))};
fc9[fc].vc=function(a,b){b&&this.u(b,a);a.prefs=a.prefs||{};a.sendViewParamsToServer=!0;a.prefs.hints=fcc.google_hints;var c={};c.url=fcd+"/friendconnect/gadgets/ads.xml";fck(c,90);this.render(this.D(a,c))};fc9[fc].Fa=function(a,b){if(a.id){b&&this.u(b,a);a["view-params"]=a["view-params"]||{};a["view-params"].opaque="true";this.i=new fc2(a);this.i.render();var c={};c.url=fcd+"/friendconnect/gadgets/friendbar.xml";a.id=this.i.F;fck(a,"1");this.render(this.D(a,c))}};fc9[fc].xc=fc9[fc].Fa;
fc9[fc].Ea=function(a,b){a=a||{};a.url=fcd+"/friendconnect/gadgets/signin.xml";a.site=a.site||fca[fcx][fcI]().site;fck(a,32);this.Da(a,b)};fc9[fc].wc=fc9[fc].Ea;fc9[fc].Cc=fc9[fc].Ca;fc9[fc].u=function(a,b){var c=b["view-params"];c||(c={},b["view-params"]=c);c.skin=a};fc9[fc].D=function(a,b){var c=this.gb(b,a);if(b["view-params"]){var d=b["view-params"];a["view-params"]&&(d=this.gb(d,a["view-params"]));c["view-params"]=d}return c};fc9[fc].zc=function(a,b){b&&this.u(b,a);this.render(a)};
fc9[fc].gb=function(a,b){var c={},d;for(d in b)c[d]=b[d];for(d in a)"undefined"==typeof c[d]&&(c[d]=a[d]);return c};
fc9[fc].render=function(a){this.openSocialSiteId=a.site;a["view-params"]=a["view-params"]||{};var b=this.V({divId:a.id,specUrl:a.url,communityId:a.site,height:a[fcz],locale:a[fcza]||this.lc,secureToken:a.securityToken,titleDivId:a.titleDivId,showEmbedThis:a.showEmbedThis,useLightBoxForCanvas:a.useLightBoxForCanvas||"undefined"==typeof a.useLightBoxForCanvas&&fcc.friendconnect_lightbox,viewParams:a["view-params"],prefs:a.prefs,originalParams:a,debug:a.debug,maxHeight:a[fcra],sendViewParamsToServer:a.sendViewParamsToServer,
keepMax:a.keepMax});a.presentation&&b.Nc(a.presentation);this.xb(b);this.K.yb(b.id,a.id);fcba(function(){fc4.R(b)},0);return b.id};fc9[fc].Bc=function(a,b){a=a||{};a.presentation="canvas";this.lb(a,b)};
fc9[fc].lb=function(a,b,c){a=a||{};a.url=fca[fcx][fcI]().url;a.site=fca[fcx][fcI]().site||a.site;var d=fca[fcx][fcI]()["view-params"];d&&(a["view-params"]=fca[fcpa].parse(decodeURIComponent(d)));c&&(a["view-params"]=a["view-params"]||{},a["view-params"].useFixedHeight=!0,fck(a["view-params"],c),b=b||{},b.HEIGHT=fci(c));this.Da(a,b)};fc9[fc].Da=function(a,b){a=a||{};b&&this.u(b,a);"1"==fca[fcx][fcI]().canvas?a.presentation="canvas":"1"==fca[fcx][fcI]().embed&&(a.presentation="embed");fc4.render(a)};
fc9[fc].Zb=function(){var a=fca[fcx][fcI]().caller;a&&fce[fcu][fcqa]!=a&&8<a[fcG]&&("http://"==a.substr(0,7)[fcFa]()||"https://"==a.substr(0,8)[fcFa]())?fce[fcu].href=a:(a=fca[fcx][fcI]().site)?fce[fcu].href=fcd+"/friendconnect/directory/site?id="+a:fcc.history.go(-1)};fc9[fc].Q="";fc9[fc].Ub=function(){return this.Q};fc9[fc].Fc=function(a){this.apiVersion=a};fc9[fc].ja=function(a){var b=fce[fcia]("link");b[fcr]("rel","stylesheet");b[fcr]("type","text/css");b[fcr]("href",a);fce.getElementsByTagName("head")[0][fcm](b)};
fc9[fc].zb=function(a){var b=fce[fcia]("script");b[fcr]("src",a);b[fcr]("type","text/javascript");fce.getElementsByTagName("head")[0][fcm](b)};fc9[fc].Ma=function(a){fce[fcJ]?a():fcc[fcxa]?fcc[fcxa]("load",a,!1):fcc.attachEvent("onload",a)};fc9[fc].va=function(a){if(!a.site)throw"API not loaded, please pass in a 'site'";this.ja(fcc[fcBa]+"/friendconnect/styles/container.css?d="+this.da);this.openSocialSiteId=a.site;this.apiLoadedCallback=a.onload;this.Ma(fcQ(this.fb,this,a,"fc-opensocial-api"))};
fc9[fc].kc=fc9[fc].va;fc9[fc].dc=function(a){var b={};b.site=this.openSocialSiteId;b["view-params"]={txnId:a};this.fb(b,"gfc-"+a)};fc9[fc].uc=function(a){var b={},c;for(c in this.o){var d=this.o[c];if(d.viewParams&&d.viewParams.txnId==a)break;else b[c]=d}this.o=b;(a=fce[fcD]("gfc-"+a))&&a.parentNode&&a.parentNode.removeChild&&a.parentNode.removeChild(a)};fc9[fc].Ob=function(){return"<Templates xmlns:fc='http://www.google.com/friendconnect/makeThisReal'>  <Namespace prefix='fc' url='http://www.google.com/friendconnect/makeThisReal'/>  <Template tag='fc:signIn'>    <div onAttach='google.friendconnect.renderSignInButton({element: this})'></div>  </Template></Templates>"};
fc9[fc].Vb=function(){return"<Templates xmlns:os='http://ns.opensocial.org/2008/markup'><Namespace prefix='os' url='http://ns.opensocial.org/2008/markup'/><Template tag='os:Name'>  <span if='${!My.person.profileUrl}'>${My.person.displayName}</span>  <a if='${My.person.profileUrl}' href='${My.person.profileUrl}'>      ${My.person.displayName}</a></Template><Template tag='os:Badge'>  <div><img if='${My.person.thumbnailUrl}' src='${My.person.thumbnailUrl}'/>   <os:Name person='${My.person}'/></div></Template><Template tag='os:PeopleSelector'>  <select onchange='google.friendconnect.PeopleSelectorOnChange(this)' name='${My.inputName}'          multiple='${My.multiple}' x-var='${My.var}' x-max='${My.max}'          x-onselect='${My.onselect}'>    <option repeat='${My.group}' value='${Cur.id}' selected='${Cur.id == My.selected}'>        ${Cur.displayName}    </option>  </select></Template></Templates>"};
...
fc9[fc].fb=function(a,b){fcc.opensocial.template.Loader.loadContent(this.Vb());fcc.opensocial.template.Loader.loadContent(this.Ob());fcc.opensocial[fcha].processDocumentMarkup();var c=fce[fcia]("div");c.id=b;fck(c[fcv],"0px");fcj(c[fcv],"0px");c[fcv].position="absolute";c[fcv].visibility="hidden";fce[fcJ][fcm](c);var d={};d.url=fcd+"/friendconnect/gadgets/osapi-"+this.apiVersion+".xml";fck(d,0);d.id=c.id;d.site=a.site;d["view-params"]=a["view-params"];this.render(d)};
fc5[fc].Ia=function(){fc4.Q=this.f;fc4.openSocialSecurityToken=this.a[0];var a=fc4.openSocialSecurityToken;fcc.opensocial[fcha].executeRequests();fcc.opensocial.template.process();fc4.apiLoadedCallback&&(a=fcNa(fc4.apiLoadedCallback,a),fcba(a,0))};fc9[fc].Y=function(a){var b=null,c;for(c in this.o)if(this.o[c].divId==a){b=this.o[c];break}return b};fc9[fc].M=function(a,b){var c=this.Y(a),d=null;c&&(d=c.M(b));return d};fc9[fc].L=function(a,b){var c=this.Y(a),d=null;c&&(d=c.L(b));return d};
fc9[fc].Oc=function(a,b){this.ga(function(c){var d=fce.createTextNode("Copy & paste this code into your site.");c[fcEa]()[fcm](d);c[fcEa]()[fcm](fce[fcia]("br"));var d=fc4.L(a,b),e=fce[fcia]("textarea");fcl(e,d);e[fcr]("style","width:500px;");c[fcEa]()[fcm](e);c.setVisible(!0)})};var fc1c="ar dv fa iw he ku pa sd tk ug ur yi".split(" "),fcYc=function(a){var b=!1;a?(a=a[fct]("_")[0],b=fcdb(fc1c,a)):b=(a=fcfc(fce[fcJ],"direction"))&&"rtl"==a;return b};
fc5[fc].tb=function(a,b){var c=0,d=null;try{var e=fc$(this.f),f=fc4.J(e),d=f.secureToken,c=f.communityId}catch(l){}b&&(c=b);fc4.Ga(a,c,this.callback,d)};fc9[fc].Ga=function(a,b,c,d){b=b||this.openSocialSiteId;a={keepMax:!0,presentation:"canvas",url:fcd+"/friendconnect/gadgets/members.xml",site:b,"view-params":{profileId:a}};d&&(a.securityToken=d);this.sb(a,c)};fc9[fc].Qb=function(a){var b=null;(a=this.Y(a))&&a.secureToken&&(b=a.secureToken);return b};
fc9[fc].Pb=function(a){var b=null;(a=this.Y(a))&&a.communityId&&(b=a.communityId);return b};var fcZc=function(a){fc4.Q&&fcyc(fc4.Q,a)},fc2c=function(){fc5[fc].signout(fc4.openSocialSiteId)},fc3c=function(){fcBc(fc4.Q)},fc4c=function(a,b){fcvc(a,b)},fcJc=function(){this.A={}};fcJc[fc].register=function(){fca.rpc[fcs]("subscribeEventType",fc5[fc].subscribe);fca.rpc[fcs]("publishEvent",fc5[fc].publish)};fc5[fc].subscribe=function(a){var b=fcWc;b.A[a]=b.A[a]||[];a=b.A[a];a[a[fcG]]={frameId:this}};
fcJc[fc].ub=function(a,b,c){var d=this;d.A[b]=d.A[b]||[];b=d.A[b];b[b[fcG]]={container:a,callback:c}};fc5[fc].publish=function(a){var b=fcWc,c=0;this.f&&(c=fc$(this.f));b.A[a]=b.A[a]||[];for(var b=b.A[a],d=0;d<b[fcG];d++)b[d].container?b[d].callback[fcK](b[d].container,a,c):fca.rpc[fcK](b[d].frameId,a,null,a,c)};var fcKc=fcQ(fc5[fc].publish,new fc5),fcWc=new fcJc,fc4=new fc9;fc4.Ma(fc4.Hb);fcR("google.friendconnect.container",fc4);fcR("google.friendconnect.container.refreshGadgets",fc4.ba);
fcR("google.friendconnect.container.setParentUrl",fc4.ea);fcR("google.friendconnect.container.setServerBase",fc4.fa);fcR("google.friendconnect.container.setServerVersion",fc4.Mc);fcR("google.friendconnect.container.createGadget",fc4.V);fcR("google.friendconnect.container.openLightboxIframe",fc4.za);fcR("google.friendconnect.container.renderGadget",fc4.R);fcR("google.friendconnect.container.render",fc4.render);fcR("google.friendconnect.container.goBackToSite",fc4.Zb);
fcR("google.friendconnect.container.renderMembersGadget",fc4.yc);fcR("google.friendconnect.container.renderReviewGadget",fc4.Ac);fcR("google.friendconnect.container.renderCommentsGadget",fc4.Ca);fcR("google.friendconnect.container.renderSignInGadget",fc4.kb);fcR("google.friendconnect.container.renderFriendBar",fc4.xc);fcR("google.friendconnect.container.renderSocialBar",fc4.Fa);fcR("google.friendconnect.container.renderCanvasSignInGadget",fc4.wc);
fcR("google.friendconnect.container.renderUrlCanvasGadget",fc4.Bc);fcR("google.friendconnect.container.renderEmbedSignInGadget",fc4.Ea);fcR("google.friendconnect.container.renderUrlEmbedGadget",fc4.lb);fcR("google.friendconnect.container.renderEmbedGadget",fc4.Da);fcR("google.friendconnect.container.renderWallGadget",fc4.Cc);fcR("google.friendconnect.container.renderAdsGadget",fc4.vc);fcR("google.friendconnect.container.renderOpenSocialGadget",fc4.zc);
fcR("google.friendconnect.container.setNoCache",fc4.pb);fcR("google.friendconnect.container.enableProxy",fc4.Sa);fcR("google.friendconnect.container.setDomain",fc4.Ic);fcR("google.friendconnect.container.setLockedDomainSuffix",fc4.Lc);fcR("google.friendconnect.container.setLocale",fc4.Kc);fcR("google.friendconnect.container.loadOpenSocialApi",fc4.kc);fcR("google.friendconnect.container.initOpenSocialApi",fc4.va);fcR("google.friendconnect.container.getOpenSocialApiIframeId",fc4.Ub);
fcR("google.friendconnect.container.setApiVersion",fc4.Fc);fcR("google.friendconnect.container.getEmbedUrl",fc4.M);fcR("google.friendconnect.container.getEmbedHtml",fc4.L);fcR("google.friendconnect.container.getGadgetSecurityToken",fc4.Qb);fcR("google.friendconnect.container.getGadgetCommunityId",fc4.Pb);fcR("google.friendconnect.container.showEmbedDialog",fc4.Oc);fcR("google.friendconnect.container.showMemberProfile",fc4.Ga);fcR("google.friendconnect.requestSignIn",fcZc);
fcR("google.friendconnect.requestSignOut",fc2c);fcR("google.friendconnect.requestSettings",fc3c);fcR("google.friendconnect.requestInvite",fc4c);fcR("google.friendconnect.renderSignInButton",fc_c);fcR("google.friendconnect.container.invokeOpenSocialApiViaIframe",fc4.dc);fcR("google.friendconnect.container.removeOpenSocialApiViaIframe",fc4.uc);fcR("google.friendconnect.userAgent.WEBKIT",fcub);fcR("google.friendconnect.userAgent.IE",fcV);fcR("google.friendconnect.PeopleSelectorOnChange",fc0c);
fcR("google.friendconnect.container.setDateStamp_",fc4.Hc);
google.friendconnect.container.setServerBase('http://www-a-fc-opensocial.googleusercontent.com/ps/');google.friendconnect.container.setServerVersion('0.1-fe7681fa_faa961a4_10d78ca1_7dedf383_37299517.7');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('14cc8112272');